...
<body style="background-color: #572364;color: white">	
	<div class="container">
		<FONT FACE="Optima"><h1>PRESENTACION IMAGENES TIPO GOOGLE</h1>
		<FONT FACE="Optima"><h2 align="center">PARAMORE</h2>
	...
	<ul class="gridder">
		...
		for ($i=0; $i < count($datos) ; $i++):
			...
			data-griddercontent="<?php echo '#gridder-content-'.$i ?>">
				<img src="<?php echo $d[0] ?>" width="100" height="280" >
			</li>
